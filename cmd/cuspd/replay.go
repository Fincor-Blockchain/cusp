...
import (
	...
	"github.com/fincor/pou/proxy"
	tmsm "github.com/fincor/pou/state"
	tmstore "github.com/fincor/pou/store"
	tm "github.com/fincor/pou/types"
...
func replayTxs(rootDir string) error {
	...
	// TM DB
	// tmDB := dbm.NewMemDB()
	fmt.Fprintln(os.Stderr, "Opening pou state database")
