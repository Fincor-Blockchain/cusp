...
import (
	...
	tmconfig "github.com/fincor/pou/config"
	"github.com/fincor/pou/crypto"
	cmn "github.com/fincor/pou/libs/common"
	"github.com/fincor/pou/types"
	tmtime "github.com/fincor/pou/types/time"

	"github.com/fincor/cusp-sdk/client"
	"github.com/fincor/cusp-sdk/client/keys"
	"github.com/fincor/cusp-sdk/codec"
	"github.com/fincor/cusp-sdk/server"
	srvconfig "github.com/fincor/cusp-sdk/server/config"
	sdk "github.com/fincor/cusp-sdk/types"
	"github.com/fincor/cusp-sdk/types/module"
	"github.com/fincor/cusp-sdk/x/auth"
	"github.com/fincor/cusp-sdk/x/genaccounts"
	"github.com/fincor/cusp-sdk/x/genutil"
	genutiltypes "github.com/fincor/cusp-sdk/x/genutil/types"
...
// get cmd to initialize all files for pou testnet and application
...
Example:
	...
	cmd.Flags().String(
		...
		"Minimum gas prices to accept for transactions; All fees in a tx must meet this minimum (e.g. 0.01psix,0.001ffnr)")
	return cmd
}
...
func InitTestnet(cmd *cobra.Command, config *tmconfig.Config, cdc *codec.Codec,
	...
	for i := 0; i < numValidators; i++ {
		...
		// (REF: https://github.com/fincor/cusp-sdk/issues/4125).
