...
import (
	...
	abci "github.com/fincor/pou/abci/types"
	"github.com/fincor/pou/libs/log"
	dbm "github.com/evdatsion/tm-db"

	"github.com/fincor/cusp-sdk/baseapp"
	"github.com/fincor/cusp-sdk/simapp"
	sdk "github.com/fincor/cusp-sdk/types"
	"github.com/fincor/cusp-sdk/x/auth"
	authsim "github.com/fincor/cusp-sdk/x/auth/simulation"
	"github.com/fincor/cusp-sdk/x/bank"
	distr "github.com/fincor/cusp-sdk/x/distribution"
	distrsim "github.com/fincor/cusp-sdk/x/distribution/simulation"
	"github.com/fincor/cusp-sdk/x/gov"
	govsim "github.com/fincor/cusp-sdk/x/gov/simulation"
	"github.com/fincor/cusp-sdk/x/mint"
	"github.com/fincor/cusp-sdk/x/params"
	paramsim "github.com/fincor/cusp-sdk/x/params/simulation"
	"github.com/fincor/cusp-sdk/x/simulation"
	"github.com/fincor/cusp-sdk/x/slashing"
	slashingsim "github.com/fincor/cusp-sdk/x/slashing/simulation"
	"github.com/fincor/cusp-sdk/x/staking"
	stakingsim "github.com/fincor/cusp-sdk/x/staking/simulation"
	"github.com/fincor/cusp-sdk/x/supply"
)
...
func invariants(app *CuspApp) []sdk.Invariant {
	...
	// Ref: https://github.com/fincor/cusp-sdk/issues/4631
	if period == 1 {
...
// Profile with:
// /usr/local/go/bin/go test -benchmem -run=^$ github.com/fincor/cusp-sdk/CuspApp -bench ^BenchmarkFullAppSimulation$ -Commit=true -cpuprofile cpu.out
