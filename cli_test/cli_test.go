...
import (
	...
	"github.com/fincor/pou/crypto/ed25519"
	tmtypes "github.com/fincor/pou/types"

	"github.com/stretchr/testify/require"

	"github.com/fincor/cusp/app"

	"github.com/fincor/cusp-sdk/client"
	"github.com/fincor/cusp-sdk/tests"
	sdk "github.com/fincor/cusp-sdk/types"
	"github.com/fincor/cusp-sdk/x/auth"
	"github.com/fincor/cusp-sdk/x/genaccounts"
...
func TestCuspCLIKeysAddRecover(t *testing.T) {
	...
	require.Equal(t, "fincor1qcfdf69js922qrdr4yaww3ax7gjml6pdds46f4", f.KeyAddress("test-recover").String())
...
func TestCuspCLIKeysAddRecoverHDPath(t *testing.T) {
	...
	require.Equal(t, "fincor1qcfdf69js922qrdr4yaww3ax7gjml6pdds46f4", f.KeyAddress("test-recoverHD1").String())
	...
	require.Equal(t, "fincor1pdfav2cjhry9k79nu6r8kgknnjtq6a7rykmafy", f.KeyAddress("test-recoverH2").String())
	...
	require.Equal(t, "fincor1909k354n6wl8ujzu6kmh49w4d02ax7qvlkv4sn", f.KeyAddress("test-recoverH3").String())
	...
	require.Equal(t, "fincor1v9plmhvyhgxk3th9ydacm7j4z357s3nhtwsjat", f.KeyAddress("test-recoverH4").String())
...
func TestSlashingGetParams(t *testing.T) {
	...
	sinfo := f.QuerySigningInfo(f.GDfincor("show-validator"))
