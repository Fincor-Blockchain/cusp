...
import (
	...
	authtypes "github.com/Fincor-Blockchain/cusp-sdk/x/auth/types"

	"github.com/Fincor-Blockchain/cusp/crypto/ethsecp256k1"
	...
	testCases := []struct {
	...
	}{
		{
			...
			func() {
				...
				err := acc.SetCoins(sdk.NewCoins(levm.NewPhotonCoinInt64(1)))
				suite.Require().NoError(err)
