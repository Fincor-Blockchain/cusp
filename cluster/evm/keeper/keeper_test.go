...
import (
	...
	"github.com/Fincor-Blockchain/cusp-sdk/x/auth"

	"github.com/Fincor-Blockchain/cusp/app"
	levm "github.com/Fincor-Blockchain/cusp/types"
	"github.com/Fincor-Blockchain/cusp/cluster/evm/keeper"
...
func (suite *KeeperTestSuite) SetupTest() {
	...
	suite.ctx = suite.app.BaseApp.NewContext(checkTx, abci.Header{Height: 1, ChainID: "levm-3", Time: time.Now().UTC()})
	suite.querier = keeper.NewQuerier(*suite.app.EvmKeeper)
	suite.address = ethcmn.HexToAddress(addrHex)

	balance := sdk.NewCoins(levm.NewPhotonCoin(sdk.ZeroInt()))
	acc := &levm.EthAccount{
